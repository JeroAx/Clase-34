...
function preload(){
  kangaroo_running =   loadImage("assets/Gringo.png");
  kangaroo_collided = loadAnimation("assets/Gringo.png");
  jungleImage = loadImage("assets/bg.png");
  shrub1 = loadImage("assets/Pizza.jpg");
  shrub2 = loadImage("assets/Pizza.jpg");
  shrub3 = loadImage("assets/Pizza.jpg");
